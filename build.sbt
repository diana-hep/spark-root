...
libraryDependencies += "org.diana-hep" % "root4j" % "0.1.4-head"
...
// libraryDependencies += "org.apache.logging.log4j" % "log4j-core" % "2.7" % "provided"
// libraryDependencies += "org.apache.logging.log4j" %% "log4j-api-scala" % "2.7" % "provided"
